...
require (
	...
	istio.io/istio v0.0.0-20240505003757-dbda74e400c4
...
require (
	...
	istio.io/client-go v1.22.0-beta.0 // indirect
	...
	sigs.k8s.io/gateway-api v1.1.0-rc1.0.20240430231933-e1b774d9e0c6 // indirect
